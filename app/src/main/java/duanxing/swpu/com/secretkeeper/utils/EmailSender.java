...
public class EmailSender extends AsyncTask{
    ...
    private static final String SENDERNAME = "SecretKeeper";
    ...
    private void generateCode() {
        ...
        for (int i = 0;i < 6;++i) {
            if(0 == i)
                verifyCode = verifyCode * 10 + random.nextInt(8) + 1;
            else
    ...
    public static void sendEmail(String toEmail, String subject, String content) throws Exception {
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, EMAILNAME, toEmail, subject, content);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String subject, String content) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, SENDERNAME, "UTF-8"));
